"""new_django_netflix URL Configuration
...
urlpatterns = [
    ...
    path('netflix/<id>/all/', browseIndex, name="browseIndex"),
    path('netflix/<id>/<category>/', browseIndexCategory, name="browseIndexCategory"),
